...
import (
	...
	appparams "github.com/hirokryptor/xyzchain/app/params"
	"github.com/hirokryptor/xyzchain/x/xyzchain"
	xyzchainkeeper "github.com/hirokryptor/xyzchain/x/xyzchain/keeper"
	xyzchaintypes "github.com/hirokryptor/xyzchain/x/xyzchain/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.xyzchain")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	xyzchainKeeper xyzchainkeeper.Keeper
...
func New(
	...
	app.xyzchainKeeper = *xyzchainkeeper.NewKeeper(
        appCodec, keys[xyzchaintypes.StoreKey], keys[xyzchaintypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		xyzchain.NewAppModule(appCodec, app.xyzchainKeeper),
